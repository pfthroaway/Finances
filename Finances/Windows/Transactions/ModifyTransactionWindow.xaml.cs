        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (newTransaction != _modifyTransaction)
            {
                ...
                if (await AppState.ModifyTransaction(newTransaction, _modifyTransaction))
                    ...
                    AppState.DisplayNotification("Unable to modify transaction.", "Finances", this);
            }
            else
                AppState.DisplayNotification("This transaction has not been modified.", "Finances", this);
        }
