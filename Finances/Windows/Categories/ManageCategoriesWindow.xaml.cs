...
namespace Finances.Windows.Categories
{
    ...
    public partial class ManageCategoriesWindow
    {
        ...
        {
            Categories.AddCategoryWindow addCategoryWindow = new Categories.AddCategoryWindow { RefToManageCategoriesWindow = this };
